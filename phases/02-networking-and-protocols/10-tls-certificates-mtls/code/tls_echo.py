...
Docs: phases/02-networking-and-protocols/10-tls-certificates-mtls/docs/en.md
...
def ensure_cert() -> None:
    ...
    building; see phases/08-auth-and-security/13-secrets-management-and-rotation.
