...
| **DaemonSet** | "One Pod on *every* node", not "N Pods total". Log shippers ([The Log Pipeline](../../10-logging-monitoring-and-observability/04-the-log-pipeline/)), metrics agents, CNI plugins. |
...
docker compose exec -T app python \
  phases/11-infrastructure-and-deployment/07-orchestration-and-kubernetes/code/orchestrator.py
```
