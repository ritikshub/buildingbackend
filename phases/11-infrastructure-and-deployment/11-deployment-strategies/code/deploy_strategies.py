...
Lesson: phases/11-infrastructure-and-deployment/11-deployment-strategies/docs/en.md
...
print()
print("  W/S = 1/(1-rho), the queueing multiplier from Phase 9, at 85% steady load:")
