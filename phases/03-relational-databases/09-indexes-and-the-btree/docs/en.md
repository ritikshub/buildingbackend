...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 820 380" width="100%" style="max-width:720px" role="img" aria-label="A B-tree with a root holding keys 30 and 60, three child nodes holding key ranges, and three leaves pointing at the heap rows in each range." font-family="'JetBrains Mono', ui-monospace, monospace" fill="currentColor">
  ...
  <g>
  <rect x="340.0" y="44" width="140" height="50" rx="9" fill="#c94a12" fill-opacity="0.14" stroke="#c94a12" stroke-width="2" stroke-linejoin="round"/>
  <rect x="85.0" y="152" width="130" height="50" rx="9" fill="#c94a12" fill-opacity="0.14" stroke="#c94a12" stroke-width="2" stroke-linejoin="round"/>
  <rect x="345.0" y="152" width="130" height="50" rx="9" fill="#c94a12" fill-opacity="0.14" stroke="#c94a12" stroke-width="2" stroke-linejoin="round"/>
  <rect x="600.0" y="152" width="144" height="50" rx="9" fill="#c94a12" fill-opacity="0.14" stroke="#c94a12" stroke-width="2" stroke-linejoin="round"/>
