...
Companion to docs/en.md (Phase 7, Lesson 10 - The Dual-Write Problem: Transactional
...
class Wal:
    """The database's durability mechanism (Phase 4 Lesson 13), re-read as a change
