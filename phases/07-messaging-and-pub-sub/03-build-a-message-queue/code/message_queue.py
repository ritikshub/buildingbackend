...
Companion to phases/07-messaging-and-pub-sub/03-build-a-message-queue/docs/en.md.
The on-disk format is a write-ahead log in the sense of Phase 4 Lesson 13:
