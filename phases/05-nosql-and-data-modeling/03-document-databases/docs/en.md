...
B-tree/hash-index idea from Phase 4, Lesson 9, now applied to schemaless documents: an index maps
...
Notice what embedding does: it **denormalizes on purpose.** In Phase 4 you learned normalization —
...
- **Index the fields you query**, exactly as in the relational world — and pay the same write cost
  for each index (Phase 4, Lesson 9).
