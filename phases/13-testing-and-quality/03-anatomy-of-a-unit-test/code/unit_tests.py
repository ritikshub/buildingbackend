...
Companion program for phases/13-testing-and-quality/03-anatomy-of-a-unit-test/
docs/en.md (Phase 13, Lesson 03). Sources: Dijkstra, "Notes on Structured
...
def main() -> None:
    ...
    print(f"Phase 13 · Lesson 03 · seed={RNG_SEED} · stdlib only")
    ctx = section_1()
    section_2()
