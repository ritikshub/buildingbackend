...
Companion to docs/en.md (Phase 13, Lesson 11). Standard library only, every RNG
...
class Clock:
    ...
    test a timeout; see Phase 13 Lesson 8."""
...
# nothing at all. Phase 9 Lesson 5 built coroutines from the ground up; this is
...
# See Phase 7 Lesson 6: exactly-once DELIVERY is impossible; exactly-once
...
def section8() -> Tuple[int, int, int]:
    ...
    print("      it moves when the suite is shuffled (Phase 13 Lesson 9).")
