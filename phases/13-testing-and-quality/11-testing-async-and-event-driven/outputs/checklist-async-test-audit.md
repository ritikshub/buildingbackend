...
projections, webhooks, schedulers. Not load testing (Phase 9 Lesson 14). Not the clock itself
(Phase 13 Lesson 8), though everything here depends on it.
...
- [ ] **One shared contract suite runs against both** (Phase 13 Lesson 4's rule). Its clauses are
