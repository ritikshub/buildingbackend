...
payment client -- carrying 31 seeded bugs from every class Phase 13 covered, plus a
...
Companion to docs/en.md (Phase 13, Lesson 15). Standard library only, one seed
