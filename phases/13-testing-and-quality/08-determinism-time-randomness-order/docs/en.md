...
docker compose exec -T app python \
  phases/13-testing-and-quality/08-determinism-time-randomness-order/code/determinism.py
```

```console
DETERMINISM · Phase 13 Lesson 08 · every RNG seeded from SEED = 20260718; no wall-clock value is printed.
