...
Companion to docs/en.md (Phase 13, Lesson 14). Standard library only, every RNG
...
# spends error budget. See Phase 10 Lesson 9 for why a latency SLI needs a
...
def section1() -> Result:
    ...
    print(f"  SLO: {SLO_TARGET:.1%} of user requests answer OK within "
          f"{LATENCY_SLI_MS:.0f} ms (a request-based SLI, Phase 10 Lesson 9)")
