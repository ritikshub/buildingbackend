...
Companion program for phases/13-testing-and-quality/
07-test-data-and-fixtures/docs/en.md (Phase 13, Lesson 07).
...
def main() -> None:
    ...
    print(f"Phase 13 · Lesson 07 · seed={SEED} · stdlib only")
    with tempfile.TemporaryDirectory() as td:
