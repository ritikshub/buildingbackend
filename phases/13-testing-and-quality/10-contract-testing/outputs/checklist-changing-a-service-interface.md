...
**Scope:** the seam between two services. Not database schema changes (Phase 11 L13), not
event schema registries in depth (Phase 7 L12), not async delivery semantics (L11).
...
- [ ] **Row 4 is the one that needs expand–contract**, not a deploy order. Add the new
      ...
      remove it (Phase 11 L13). Measured: 1,521 failures consumer-first and 1,546
