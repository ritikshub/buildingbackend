...
Use the load-test methodology from Phase 9 L14. Do not improvise it. Per level:
...
5. [ ] **Shed load if still short of demand** — Phase 9 L11. Complementary, not alternative.
