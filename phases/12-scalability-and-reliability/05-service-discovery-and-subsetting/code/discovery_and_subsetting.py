#!/usr/bin/env python3
"""Phase 12 · Lesson 05 — Service Discovery, Client-Side Balancing & Subsetting.

Companion program for
phases/12-scalability-and-reliability/05-service-discovery-and-subsetting/docs/en.md
