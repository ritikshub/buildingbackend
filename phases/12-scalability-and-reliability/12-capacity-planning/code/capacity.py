#!/usr/bin/env python3
"""
Phase 12, Lesson 12 — Capacity Planning: Headroom, Peak & What to Actually Buy.
Companion to phases/12-scalability-and-reliability/12-capacity-planning/docs/en.md
...
# One instance, as it would come off a load test (Phase 9, Lesson 14).
...
def section4(peak: float, rho_safe: float, fleets: dict) -> None:
    ...
    print("  (Phase 9 Lesson 11's retry storm, now with 3 AZs' worth of clients in it).")
