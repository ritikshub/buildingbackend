...
Companion program for phases/12-scalability-and-reliability/
09-failure-domains-and-shuffle-sharding/docs/en.md (Phase 12, Lesson 09).
...
def main() -> None:
    ...
    print("Phase 12 · Lesson 09 · seed=7 · stdlib only")
    section_1()
    section_2()
    section_3()
    section_4()
