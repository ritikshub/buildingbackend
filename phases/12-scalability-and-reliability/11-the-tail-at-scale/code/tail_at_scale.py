#!/usr/bin/env python3
"""Phase 12 - Lesson 11: The Tail at Scale (fan-out, hedged requests, correlated failure).

Companion program for phases/12-scalability-and-reliability/11-the-tail-at-scale/docs/en.md.
...
def section3() -> float:
    ...
    print("  A hedge without a budget is a retry without a budget. Phase 9 Lesson 11")
...
def section7() -> None:
    ...
    print("  capacity spent on an answer nobody is waiting for - Phase 9's goodput")
