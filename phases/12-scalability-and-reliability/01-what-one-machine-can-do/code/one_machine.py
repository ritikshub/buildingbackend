#!/usr/bin/env python3
"""
Phase 12, Lesson 01 — What One Machine Can Actually Do.
Companion to phases/12-scalability-and-reliability/01-what-one-machine-can-do/docs/en.md
...
def main() -> None:
    ...
    print("  one worker process per core — a single CPython process does not (Phase 9 L02).")
    ...
    if small:
        ...
        print("  (Phase 9 L13) and profile before you provision.")
