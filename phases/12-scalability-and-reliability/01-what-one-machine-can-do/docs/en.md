...
docker compose exec -T app python \
  phases/12-scalability-and-reliability/01-what-one-machine-can-do/code/one_machine.py
```
...
== 2 · ONE REQUEST, DECOMPOSED — WHICH WALL BINDS FIRST ==
  ...
  one worker process per core — a single CPython process does not (Phase 9 L02).
