#!/usr/bin/env python3
"""Phase 12, Lesson 14 - Capstone: Survive the Region Loss.
Companion to phases/12-scalability-and-reliability/14-capstone-survive-the-region-loss/docs/en.md
...
def run(cfg: Cfg, seed: int = SEED, sample_latency: bool = True) -> dict:
    ...
    while t < T_END - 1e-9:
        while stage_idx + 1 < len(STAGES) and t >= STAGES[stage_idx + 1][1]:
            ...
            # dropping all the load at once with extra steps (Phase 9 L11).
