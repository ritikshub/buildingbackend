...
do nothing), not a bad deploy (roll back), not a dependency outage (shed load — see Phase 9
Lesson 11).
...
- [ ] **If capacity is short, shed by tier immediately** (Phase 9 Lesson 11). Tier 3 to zero,
...
- [ ] Error rate and p99 back inside SLO (Phase 10 Lesson 9).
- [ ] Queue depth and consumer lag draining, not growing (Phase 7).
